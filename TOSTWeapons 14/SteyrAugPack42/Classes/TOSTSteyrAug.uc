...
// Version	Changes
// 0.5		+ first release
// 0.6		+ added added solid/trans textures
//----------------------------------------------------------------------------

class TOSTSteyrAug extends TOSTWeaponNoRecoilBug;
...
defaultproperties
{
    ...
    WeaponDescription="Classification: Steyr Aug Automatic Rifle w/ Scope"
    PickupAmmoCount=30
    bRapidFire=True
	Mass=25.000000
    MyDamageType=shot
    ...
    InventoryGroup=4
    PickupMessage="You picked up the Steyr Aug !"
    ItemName="Steyr Aug"
