Class AssaultChildChangeTeamWindow extends s_ChildChangeTeamWindow;
...
function Notify (UWindowWindow B, byte E)
{
	...
	switch (E)
	{
		...
		switch (B)
		{
			...
			SpeechChild=SpeechWindow(ParentWindow.CreateWindow(Class'AssaultChildTerroristTeam',100,100,100,100));
			SpeechChild.FadeIn();
			break;
			...
			HideChildren();
			CurrentType=SpeechButton(B).Type;
			SpeechChild=SpeechWindow(ParentWindow.CreateWindow(Class'AssaultChildSWATTeam',100.00,100.00,100.00,100.00));
			SpeechChild.FadeIn();
			break;
			default:
		}
