class AssaultBrowserModFact expands UBrowserGSpyFact;
...
function Query (optional bool bBySuperset, optional bool bInitial)
{
	...
	Link=GetPlayerOwner().GetEntryLevel().Spawn(Class'AssaultBrowserModLink');
	AssaultBrowserModLink(Link).GameType=GameType;
