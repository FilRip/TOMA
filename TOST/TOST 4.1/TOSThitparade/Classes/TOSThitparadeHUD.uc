...
// File    : TOSThitparadeHUD.uc
// Version : 1.0.1
// Author  : [BB]Stark <stark@bbclan.de>
// $LastChange: 05.07.2003 19:57:03$
//----------------------------------------------------------------------------
// Version	Changes
// 0.1		+ First Release
// 0.2      + not displayed when other HUDs are open
// 1.0		+ first public release
// 1.0.1    + alignment, more Lines 10->MaxLines and default colors...
//----------------------------------------------------------------------------
