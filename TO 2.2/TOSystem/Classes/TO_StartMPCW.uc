...
class TO_StartMPCW expands TO_PracticeSessionCW;
...
function DedicatedPressed()
{
	...
	GetPlayerOwner().ConsoleCommand("RELAUNCH "$URL$LanPlay
		$" -server INI=TacticalOps.ini USERINI=TOUser.ini log="$GameClass.Default.ServerLogName);
}
