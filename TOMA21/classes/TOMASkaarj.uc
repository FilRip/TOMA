...
// Skaarj.
//=============================================================================
class TOMASkaarj extends TOMAScriptedPawn
	abstract;
...
function SpeakOrderTo(ScriptedPawn TeamMember)
{
	...
	{
		if (TOMASkaarjWarrior(TeamMember) != None)
			TOMASkaarjWarrior(TeamMember).phrase = '';
		TeamMember.Speak();
	}
}
...
function PlayHeadDeath(name DamageType)
{
		 ...
		 && !Level.Game.bVeryLowGore )
	{
		...
		if ( IsA('TOMASkaarjWarrior') && (Velocity.Z < 120) )
		{
