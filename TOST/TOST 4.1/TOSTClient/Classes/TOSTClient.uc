...
function 		EventInit()
{
	...
	//RegisterGUITab(PackageName$".TOSTGUISetupTab"); // experimental...

	WR = spawn(class'TOSTWeaponRenamer', self);
	WR.Rename();

	P = TOST.GetPieceByName("TOST TOP2 Support");
	if (P != none)
		TOPVersion = "supporting TOProtect Build "$Right(P.PieceVersion, 3);
