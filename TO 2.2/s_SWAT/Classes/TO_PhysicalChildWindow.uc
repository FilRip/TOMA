...
class TO_PhysicalChildWindow expands s_SWATWindow;
...
/*
TauntCommand(3)="taunt taunt1"
PhysicalTaunts(3)="Chicken Dance"
*/
...
defaultproperties
{
     ...
     TauntCommand(2)="taunt wave"
     TauntCommand(3)="taunt victory2"
     PhysicalTaunts(0)="Chicken Dance"
     PhysicalTaunts(1)="Bow"
     PhysicalTaunts(2)="Wave"
     PhysicalTaunts(3)="Dance"
