class TO_GUIImageListbox extends TO_GUIBaseListBox;

var Texture ItemsImage[31];
...
simulated function byte AddItem (Texture Tex, int Data, bool sel, optional bool Group)
{
}
