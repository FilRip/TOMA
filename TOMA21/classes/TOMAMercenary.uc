...
// Mercenary
//=============================================================================
class TOMAMercenary extends TOMAScriptedPawn;
...
function SpeakOrderTo(ScriptedPawn TeamMember)
{
	...
	{
		if (TOMAMercenary(TeamMember) != None)
			TOMAMercenary(TeamMember).phrase = '';
		TeamMember.Speak();
	}
}
...
defaultproperties
{
     ...
     NameOfMonster="Mercenary"
	MoneyDroped=300
	sshot1="TOMATex21.Sshot.Mercenary"
}
